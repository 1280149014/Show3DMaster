...
import org.ok.android_3d_model_engine.animation.Animator;
import org.ok.android_3d_model_engine.drawer.RendererFactory;
import org.ok.android_3d_model_engine.model.AnimatedModel;
import org.ok.android_3d_model_engine.model.Camera;
import org.ok.android_3d_model_engine.model.Element;
import org.ok.android_3d_model_engine.drawer.Renderer;
import org.ok.android_3d_model_engine.model.Object3DData;
import org.ok.android_3d_model_engine.objects.Axis;
import org.ok.android_3d_model_engine.objects.BoundingBox;
import org.ok.android_3d_model_engine.objects.Grid;
import org.ok.android_3d_model_engine.objects.Line;
import org.ok.android_3d_model_engine.objects.Normals;
import org.ok.android_3d_model_engine.objects.Point;
import org.ok.android_3d_model_engine.objects.Skeleton;
import org.ok.android_3d_model_engine.objects.Wireframe;
import org.ok.android_3d_model_engine.services.SceneLoader;
import org.ok.util.android.AndroidUtils;
import org.ok.util.android.GLUtil;
...
public class ModelRenderer implements GLSurfaceView.Renderer {
    ...
    private static final float near = 8f;
...
//         GLES20.glEnable(GLES20.GL_CULL_FACE);
    ...
    private void drawObject(float[] viewMatrix, float[] projectionMatrix,
                            ...
                            boolean drawLighting, boolean drawWireframe,
                            boolean drawTextures, boolean drawColors,
                            List<Object3DData> objects, int i) {
